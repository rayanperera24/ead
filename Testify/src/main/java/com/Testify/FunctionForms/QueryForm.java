...
public class QueryForm extends javax.swing.JDialog {
    ...
    public QueryForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    public QueryForm(String qCode) {
        this.qCode = qCode;
    ...
    private void initComponents() {
        ...
        nextButton.setBackground(new java.awt.Color(146, 227, 169));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/choose1.png"))); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(nextButton, javax.swing.GroupLayout.PREFERRED_SIZE, 248, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(34, 34, 34)
...
//                insertResult(qCode, Main.userID, correctCounter, falseCounter);
                ...
                MarksForm rc = new MarksForm(quizCode);
                rc.setVisible(true);
            }
        } catch (Exception e) {
            e.printStackTrace();
...
//            JOptionPane.showMessageDialog(rootPane, "Error recording the answer.");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                QueryForm dialog = new QueryForm(new javax.swing.JFrame(), true);
